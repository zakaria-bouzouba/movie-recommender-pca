...
Ce projet implémente un système de recommandation de films utilisant l'apprentissage automatique (Machine Learning) et une interface web Flask. Le cœur du système repose sur l'Analyse en Composantes Principales (ACP/PCA) pour réduire la dimensionnalité des données utilisateurs-films et identifier des modèles latents dans les préférences cinématographiques.
...
├── setup\_data.py    # Script d'automatisation de téléchargement des données
